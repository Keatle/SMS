...
class PoliticalSocietiesList extends StatefulWidget {
  @override
  PoliticalSocietiesListPageState createState() => PoliticalSocietiesListPageState();
}

class PoliticalSocietiesListPageState extends State<PoliticalSocietiesList> {
...
final String baseUrl = 'http/localhost:3006/';
  ...
  Future<void> _fetchSocieties() async {
    final url = Uri.parse('$baseUrl/societies/Political');
    try {
