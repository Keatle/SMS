...
import 'package:byte_blossoms/screens/searchSocietyName.dart';
...
class SocietyDetailPage extends StatelessWidget {
  ...
  Future<void> _joinSociety(BuildContext context, String societyID) async 
  {
    try 
    {
      ...
      final url = Uri.parse('http://192.168.149.71:27/api/getRequirements/$societyID');
  ...
  Widget build(BuildContext context) {
    final imageUrl = society.societyIcon.isNotEmpty
        ? 'http://192.168.149.71:27${society.societyIcon}'
