...
class SocialSocietyList extends StatefulWidget {
  @override
  SocialSocietiesListPageState createState() => SocialSocietiesListPageState();
}

class SocialSocietiesListPageState extends State<SocialSocietyList> {
...
final String baseUrl = 'http/localhost:3006/';
  ...
  Future<void> _fetchSocieties() async {
    final url = Uri.parse('$baseUrl/societies/sport');
    try {
