...
import 'package:byte_blossoms/screens/SearchScreens/searchSocietyName.dart';
...
class DashboardStudent extends StatefulWidget {
  ...
  const DashboardStudent({ required this.userID, required this.studentN}) ;
                ...
                IconButton(
                  ...
                  onPressed: () {
                    Navigator.push(
                      context,
                      MaterialPageRoute(
                        builder: (context) => SocietySearchPage(),
                      ),
                    );
                  },
                ),
