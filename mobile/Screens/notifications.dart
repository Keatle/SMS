...
final String baseUrl = 'http/localhost:3006/';
  ...
  Future<List<NotificationModel>> fetchNotifications(String userID) async {
    try {
      ...
      final response = await http.get(Uri.parse('$baseUrl/notifications/$userID/Members'), headers: {
    ...
    return TextField(
      ...
      decoration: InputDecoration(
        ...
        suffixIcon: IconButton(
          ...
          onPressed: () => _searchNotifications(_searchController.text),
        ),
      ),
      onChanged: (value) => _searchNotifications(value),
    );
  }
