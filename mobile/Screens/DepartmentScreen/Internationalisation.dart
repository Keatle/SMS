...
class InternationalisationSocietiesList extends StatefulWidget {
  @override
  _InternationalisationSocietiesListPageState createState() => _InternationalisationSocietiesListPageState();
}

class _InternationalisationSocietiesListPageState extends State<InternationalisationSocietiesList> {
...
final String baseUrl = 'http/localhost:3006/';
  ...
  Future<void> _fetchSocieties() async {
    final url = Uri.parse('$baseUrl/societies/entertainment');
    try {
