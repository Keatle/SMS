...
import 'package:byte_blossoms/screens/societyDetails.dart';
...
class _SocietySearchPageState extends State<SocietySearchPage> {
  ...
  Future<List<Society>> _fetchSocieties(String query) async {
    final url = Uri.parse('$baseUrl/searchSociety');
            ...
            itemBuilder: (context, index) {
              ...
              return ListTile(
                leading: CircleAvatar(
                  backgroundImage: NetworkImage('$baseUrl${society.societyIcon}'),
                ),
