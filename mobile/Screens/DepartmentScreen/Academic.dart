...
class AcademicSocietiesList extends StatefulWidget {
  @override
  _AcademicSocietiesListPageState createState() => _AcademicSocietiesListPageState();
}

class _AcademicSocietiesListPageState extends State<AcademicSocietiesList> {
...
final String baseUrl = 'http/localhost:3006/';
  ...
  Future<void> _fetchSocieties() async {
    final url = Uri.parse('$baseUrl/societies/academic');
    try {
