...
class ReligiousSocietiesList extends StatefulWidget {
  @override
  _ReligiousSocietiesListPageState createState() => _ReligiousSocietiesListPageState();
}

class _ReligiousSocietiesListPageState extends State<ReligiousSocietiesList> {
...
final String baseUrl = 'http/localhost:3006/';
  // Secure the authorization tokens.
  final storage = FlutterSecureStorage();

  Future<void> _fetchSocieties() async {
    final url = Uri.parse('$baseUrl/societies/religious');
    try {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      children: [
        ...
        // Additional widgets can be added to the Stack as needed, such as overlays, headers, or floating buttons.
      ],
    ),
    );
  }
